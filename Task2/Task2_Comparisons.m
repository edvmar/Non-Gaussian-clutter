...
pAllUnknown        = load(strcat("Z:\Non-Gaussian-clutter-main\UnknownSigma\Probabilities_UnknownSigma_2e6",models,".mat"));
...
set(gca, 'XScale', 'log');
xlabel('P_{FA}'), ylabel('P_{TD}')
legend( 'All known', 'Unknown \alpha','Unknown \alpha, \omega','Unknown \alpha, \omega, \Sigma', location = 'southeast',FontSize=14)
axis([1e-6, 1, 0, 1])
